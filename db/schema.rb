...
ActiveRecord::Schema.define(version: 2018_09_05_193135) do
  ...
  create_table "claims", force: :cascade do |t|
    ...
    t.index ["reasonable_type", "reasonable_id"], name: "index_claims_on_reasonable_type_and_reasonable_id"
  end
  ...
  create_table "friend_suggestions", force: :cascade do |t|
    t.string "name"
    t.string "phone_number"
    t.bigint "vacancy_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["vacancy_id"], name: "index_friend_suggestions_on_vacancy_id"
  end
  ...
  create_table "services", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "icon"
    t.boolean "by_agreement", default: false
